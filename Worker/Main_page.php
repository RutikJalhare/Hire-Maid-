...
$sql="SELECT * FROM  worker_table_reg where id=".$_SESSION['worker'];
...
<a href="notification.php"><i class="fa-solid fa-bell  text-danger"><span class="text-success"><?php echo $not_count?></span></i>
          ...
          <a href="profile.php">
            ...
            src="workerphoto/<?php echo $photo ;?>" data-holder-rendered="true">
          ...
          <br/>
          <label class="form-check-label fw-bold text-info" ><?php echo $approve_status?></label>
...
<?php
        ...
        <div class="m-1">
            ...
            <!-- Card content -->
            <div class="card-body">
              <a href="Accept_order.php?order=Accpted&userid=<?php echo $U_id ; ?>&orde_id=<?php echo $ord_id ; ?>"><button type="button" class="btn btn-primary btn-rounded">Accept </button></a>
             
              <a href="Accept_order.php?order=Reject&userid=<?php echo $U_id ; ?>&orde_id=<?php echo $ord_id ; ?>"><button  type="button" class="btn btn-danger btn-rounded">Decline </button></a>
