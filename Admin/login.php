...
while($rows=mysqli_fetch_assoc($res2))
{
 $id=$rows['id'];
 session_start();
  $_SESSION["workeadmin"] = $id;

}

// header("location:http://localhost/Laundry%20Management%20FINAL%20php/Laundry%20Management%20FINAL/Laundry%20Management%20FINAL/Laundry-mana
// gment/Admin/Mainpage.php
// ");

  
header("location:http://localhost/LaundryManagementFINALphp/LaundryManagementFINAL/LaundryManagementFINAL/Laundry-managment/Admin/Mainpage.php");
                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                      ...
                      <form method="POST">
                        ...
                        <div class="form-outline mb-3">
                          <input type="text" id="form2Example17"  name="email" placeholder="Enter User Here" class="form-control form-control-lg" />
                      
                        </div>
      
                        <div class="form-outline mb-3">
                            <input type="text" id="form2Example17" name="password" placeholder="Enter Password Here" class="form-control form-control-lg" />
                        
                          </div>
                        <div class="pt-1 mb-4">
                    <input name="login" type="submit"   value="Login" class="btn fw-bold btn-primary btn-lg
                     btn-block " />
                  
                       <!-- <button  name="login" 
                    class="btn btn-primary btn-block btn-lg gradient-custom-4
                     text-body">login</button>   -->
